import { validateRequire, validateAllCn, validateAllNumber, validateEmail, validateMobile, validateLicense, validateIdCard } from 'abbott-methods/import'
...
export const rulesForm = {
  ...
  legalCertNo: [{ validator: (rule, value, callback) => validateIdCard(rule, value, callback, fields.legalCertNo) }],
  ...
  agentCertNo: [{ validator: (rule, value, callback) => validateIdCard(rule, value, callback, fields.agentCertNo) }],
